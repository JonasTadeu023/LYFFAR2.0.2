          ...
          <div class="container col s12" id="cadastro" >
            <div class="card hoverable center-align col s6 offset-s5 grey lighten-3">
              <div class="card-content black-text">
                <span class="card-title">Relembrar</span>
                  <form class="col s12" method="POST" action="../actions/postar.php" enctype="multipart/form-data">
                    <p>
                      <div class="input-field">
                        <i class="material-icons prefixe"></i><input class="validate" name="legenda" placeholder="Turma de 92" id="nome_cad" type="text" required="required">
                        <label for="nome_cad">Legenda </label>
                      </div>
                    <p>
                    <p>
                      <div class="input-field">
                        <i class="material-icons prefixe"></i><input class="validate" name="descricao" placeholder="Formatura da nossa turma em 1992" id="email_cad" type="text" required="required">
                        <label for="email_cad">História/recordações</label>
                      </div>
                    <p>
                    <p>
                      <div class="input-field ">
                        <i class="material-icons prefixe"></i><input class="validate" name="ano" placeholder="" id="senha_cad" type="number" required="required">
                        ...
                        <button class="btn waves-effect waves-light #673ab7 grey darken-4" type="submit" name="action">Relembrar</button>
                        <br>
                    </form>
                    <br>
            </div>     
