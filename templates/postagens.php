...
<body>
    ...
    <?php
        $sql1 = mysqli_query($connect, "SELECT * FROM postagens WHERE stats = '1' AND post_usuario != '$nome' ORDER BY post_data DESC");
    ...
    <div class="row">
        <div class="col s12 m6 l6  grey darken-4 center" style="margin-left:375px; margin-top:-18px">
            ...
            <?php echo "<a href='../actions/postagem.php?id=$id'> <img style='border-radius:15px;height:150px;shadow-color:white' class='hoverable '  src='../users/$usuario/$fotopos'></a>" ?>
