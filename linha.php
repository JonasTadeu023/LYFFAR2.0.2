...
<body>
    ...
    <div class="row ">
        <div class="col s12 m6 l6  grey darken-4  " style="margin-left:375px; margin-top:-19px">
            <h5 class=" white-text center left" >Linha do tempo</h5 >
        </div>
    </div>

    <?php
        $sql1 = mysqli_query($connect, "SELECT * FROM postagens ORDER BY post_ano asc");
    ...
    <div class="row">
        <div class="col s12 m6 l6  grey darken-4 center" style="margin-left:375px; margin-top:-18px">
            ...
            <h6 class=" white-text right" ><?php echo "$usuario -"?><?php echo $ano ?></h6>
            <br><br>
